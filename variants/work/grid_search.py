...
if __name__ == '__main__':
    ...
    if mtd == 'GBM':
        param_grid = dict(
            ...
            max_depth=[1, 2, 3],
            learning_rate=[0.001, 0.01, 0.2, 0.3, 0.05, 0.075, 0.1])
        ...
        grid.fit(trn.train_set_X, trn.train_set_y)
...
params1 = {
    'RandomForestClassifier': dict(n_estimators=[100, 200, 500, 1000, 2000]),
...
helper1.score_summary(sort_by='mean_score').to_csv('grid_search_0518_50K_LogReg.csv',
                                                   index=False)
